...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        <a class="navbar-brand" href="<?php echo e(route('teacherCourse')); ?>">Admin Dashboard</a>
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo e(route('lookTeacherList')); ?>">Teacher <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo e(route('studentList')); ?>">Student<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo e(route('sendNotification')); ?>">Sent Notification <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo e(url('admin/addAdmin')); ?>">Add Admin<span class="sr-only">(current)</span></a>
                </li>
            </ul>
...
</html><?php /**PATH C:\xampp\htdocs\school\resources\views/layouts/adminDesign.blade.php ENDPATH**/ ?>