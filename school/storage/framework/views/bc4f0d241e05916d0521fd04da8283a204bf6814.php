            ...
            <div class="card">
                <div class="card-body">
                    <div class="alert alert-success" role="alert">
                        <h5 class="card-title"><label>Teacher Name - <?php echo e($teacher[0]->name); ?></label></h5>
                    </div>
                    <hr>
                    <p class="card-text">Phone - <?php echo e($teacher[0]->phone_number_one); ?></p>
                    <hr>
                    <p class="card-text">Region - <?php echo e($teacher[0]->region); ?></p>
                    <hr>
                    <!-- <div class="alert alert-success" role="alert">
                        <label></label>
                    </div> -->
...
<?php echo $__env->make('layouts.studentDesign', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\school\resources\views/student/teacher/lookTeacherCourse.blade.php ENDPATH**/ ?>